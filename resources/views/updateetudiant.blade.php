        ...
        <div class="box">
            <div class="container">
               <div class="form">
                ...
                <form action="{{ route('updatestore',['id' => $etudiant->id]) }}" method="POST" enctype="multipart/form-data">
                @csrf
                  <div class="inputBox">
                    <input type="text" name="nom" value="{{ $etudiant->nom_e }}" placeholder="nom" >
                  </div>
                  <div class="inputBox">
                    <input type="text" name="prenom" value="{{ $etudiant->prenom_e }}" placeholder="prenom" >
                  </div>
                  <div class="inputBox">
                    <input type="text" name="adresse" value="{{ $etudiant->adresse }}" placeholder="Adresse" >
                  </div>
                  <div class="inputBox">
                    <input type="text" name="telephone" value="{{ $etudiant->telephone }}" placeholder="Telephone" >
                  </div>
                  <div class="inputBox">
